...
@section('content')
    ...
    <div class="app-content content container-fluid"  style="background: #fff;">
        <div class="container-fluid f-bar" style="padding:15px;">
            <div class="col-xs-4 col-md-4">
                <input id="search_church" class="form-control" placeholder="search_coordinator.....">
            </div>
            <div class="col-xs-4 col-md-4">
            ...
            <div class="col-md-4">
                <div class=" text-right" style="text-align:right">
                    <a class="btn btn-primary btn-md" data-toggle="modal" data-target="#addCoordinator" href="#"> <i class="fa fa-plus"></i> New Member</a>
                </div>
            </div>
        </div>
                        ...
                        @foreach($coordinators as $coordinator)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete{{$coordinator->id}}" class="btn btn-danger">Remove</a>
                                </td>
                            </tr>
    ...
    @foreach($coordinators as $coordinator)
        ...
        <!------------------------- delete (Confirm)? Modal ------------------------------>
            <div id="delete{{$coordinator->id}}" class="modal fade" tabindex="-1"  role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        {!! Form::open(['method'=>'post', 'route'=>['Coordinator.remove',$coordinator->id]]) !!}
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Delete Confirmation</h4>
                        </div>
                        <div class="modal-body">
                            <p>Are you sure you want to remove {{$coordinator->firstname}}, {{$coordinator->lastname}}?</p>
                        </div>
                        <div class="modal-footer">
    ...
    <!--------------------- Add New Member --------------------------->
        <div id="addCoordinator" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">

                    {!! Form::open(['method' => 'POST', 'url' => 'addCoordinator', 'class' => 'form-horizontal']) !!}
                    <div class="modal-header">
